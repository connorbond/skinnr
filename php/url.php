<?php
	...
	curl_close($ch);
	if ($hCode=='200' && $type == 'png' || $type == 'jpg') {
		$im = imagecreatefromstring($img);
		echo '<div class="topMsg"><h4>Loaded URL - Type: '.$type.'</h4>';
		...
		echo '<div class="topMsg"><h4>Error loading from URL - Type: '.$type.'</h4>';
		echo '<p>Source: '.$file_url.'</p></div>';
		echo '<br><p><img src="img/sad.png" width="80px" height="80px" /></p><br><p>Images must be .jpg or .png.</p>';
		suggest();
	}
